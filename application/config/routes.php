...
$route['translate_uri_dashes'] = FALSE;
$route['test'] = 'test';
$route['guitar/ha-noi/inbound'] = 'mon_hoc/lp/guitar/ha-noi';
$route['piano/ha-noi/inbound'] = 'mon_hoc/lp/piano/ha-noi';
...
// $route['thanhnhac/(:any)'] = 'thanhnhac/city/$1/1';
// $route['thanhnhac/(:any)/(:num)'] = 'thanhnhac/city/$1/$2';
