...
<head>
    ...
    <script>
        (function(h,o,t,j,a,r){
            ...
            h._hjSettings={hjid:618218,hjsv:5};
	...
	<script>
		...
		})(window,document,'script','dataLayer','GTM-5SQR968');
	</script>
...
<div class="container hgd-container">
	...
	<?php if ($cur_page > 1): ?>
		<li><a href="<?php echo base_url('guitar/ha-noi/1') ?>" title="">&lt;&lt;</a></li>
		<li><a href="<?php echo base_url('guitar/ha-noi/'.($cur_page-1)) ?>" title="">&lt;</a></li>
	<?php endif; ?>

	<?php for ($i = $min_page; $i <= $max_page; $i++) {?>
		<?php if ($i == $cur_page) {?>
		<li class="active"><a href="<?php echo base_url('guitar/ha-noi/'.$i) ?>"><?php echo $i ?></a></li>
		<?php } else { ?>
		<li><a href="<?php echo base_url('guitar/ha-noi/'.$i) ?>"><?php echo $i ?></a></li>
		<?php } ?>
	<?php } ?>

	<?php if ($cur_page < $total_pages): ?>
		<li><a href="<?php echo base_url('guitar/ha-noi/'.($cur_page+1)) ?>">&gt;</a></li>
		<li><a href="<?php echo base_url('guitar/ha-noi/'.$total_pages) ?>">&gt;&gt;</a></li>
	<?php endif; ?>
	</ul>
	<?php endif; ?>
