...
<div class="container hgd-container">
	...
	<?php if ($cur_page > 1): ?>
		<li class="first direction appear"><a href="<?php echo base_url($subject.'/ha-noi?p=1') ?>"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a></li>
		<li class="prev direction appear"><a href="<?php echo base_url($subject.'/ha-noi?p='.($cur_page-1)) ?>" title=""><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
	<?php endif; ?>

	<?php for ($i = $min_page; $i <= $max_page; $i++) {?>
		<?php if ($i == $cur_page) {?>
		<li class="active number appear"><a href="<?php echo base_url($subject.'/ha-noi?p='.$i) ?>"><?php echo $i ?></a></li>
		<?php } else { ?>
		<li class="number appear"><a href="<?php echo base_url($subject.'/ha-noi?p='.$i) ?>"><?php echo $i ?></a></li>
		<?php } ?>
	<?php } ?>

	<?php if ($cur_page < $total_pages): ?>
		<li class="next appear direction" ><a href="<?php echo base_url($subject.'/ha-noi?p='.($cur_page+1)) ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
		<li class="last appear direction"><a href="<?php echo base_url($subject.'/ha-noi?p='.$total_pages) ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
	<?php endif; ?>
	    </ul>
	</div>
	<?php endif; ?>
