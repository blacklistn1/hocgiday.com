...
<p>Khi sử dụng dịch vụ của chúng tôi bạn đồng ý không:
</p>
<ul>
	<li>Giới hạn hoặc ngăn cấm bất cứ người truy cập khác hoặc thành viên sử dụng dịch vụ của chúng tôi, bao gồm cả bằng cách “hack” hoặc làm xấu bất kỳ phần nào của Dịch vụ của chúng tôi</li>
	<li>Sử dụng dịch vụ của chúng tôi cho mục đích phi pháp</li>
	<li>Thể hiện hay ngụ ý rằng bất kỳ báo cáo nào bạn thực hiện cũng đều được thông qua, mà không có sự đồng ý trước bằng văn bản của chúng tôi</li>
	<li>Truyền <ul>
		<li>Bất kỳ nội dung, ngôn ngữ, hình ảnh, hoặc các thông tin trái pháp luật, lừa đảo, đe dọa, quấy rối, lạm dụng, bôi nhọ, nói xấu, khiêu dâm hoặc gây khó chịu, hoặc vi phạm sở hữu trí tuệ của chúng tôi hoặc của bên thứ ba hoặc các quyền khác</li>
		<li>Bất kỳ tài liệu, thông tin không công khai về các công ty mà không được phép</li>
		<li>Bất kỳ bí mật thương mại nào của bất kỳ bên thứ ba nào</li>
		<li>Tham gia vào spamming</li>
		<li>Vi phạm hoặc phá vỡ bất kỳ luật lệ, quyền của bên thứ ba hoặc các hệ thống, chính sách của chúng tôi và các quyết định về tình trạng tài khoản của bạn</li>
		<li>Truyền tải bất kỳ phần mềm hoặc các vật liệu khác có chứa bất kỳ loại virus, worm, time bomb, Trojan horse, hoặc thành phần gây hại hoặc gây rối khác</li>
		<li>Sửa đổi, điều chỉnh, cấp giấy phép, dịch, bán hoặc dịch ngược bất cứ phần nào của trang web hoặc dịch vụ của chúng tôi</li>
		<li>Hủy bỏ bất kỳ bản quyền, nhãn hiệu hoặc thông báo quyền sở hữu khác chứa trên Website hoặc được áp dụng cho các dịch vụ của chúng tôi</li>
		<li>“Nhân bản” bất kỳ phần nào của trang web hoặc dịch vụ của chúng tôi mà không có sự cho phép trước bằng văn bản của chúng tôi</li>
		<li>Tạo nhiều hơn một hồ sơ mà không có sự đồng ý bằng văn bản của chúng tôi</li>
		<li>Cho phép bất cứ ai khác có tài khoản hoặc đăng ký đã được chấm dứt, hoặc những người không phải là một Thành viên, để sử dụng dịch vụ của chúng tôi thông qua đăng ký, tên người dùng hoặc mật khẩu của bạn</li>
		<li>Tham gia vào các hoạt động thương mại và / hoặc sales mà không có sự đồng ý trước bằng văn bản của chúng tôi như các cuộc thi, rút ​​thăm trúng thưởng, và các quảng cáo</li>
		<li>Gây rối trong các bài học hoặc hướng dẫn nhóm</li>
		<li>Lôi kéo bất kỳ giáo viên hoặc học sinh nào để làm việc với hoặc cho một công ty khác để làm dịch vụ ký kết hợp đồng độc lập, trình diễn, hoặc các dịch vụ khác</li>
		<li>Tham gia vào bất kỳ thông tin liên lạc liên quan đến hành vi tình dục, hoặc lăng mạ.</li>
	</ul></li>
</ul>
...
<h2>8. CHỐNG SỬ DỤNG TRÁI PHÉP
 </h2> 

<p>Việc sử dụng dịch vụ của chúng tôi chỉ được dưới sự cho phép của chúng tôi, mà có thể bị thu hồi bất cứ lúc nào, vì bất cứ lý do, tuỳ ý của chúng tôi. Việc sử dụng bất hợp pháp và / hoặc trái phép các dịch vụ của chúng tôi có thể bị truy tố hình sự.
</p>
 

<h2>9. BẢO MẬT TÀI KHOẢN
 </h2> 
...
<ul>
	<li>Thông báo ngay cho chúng tôi về bất kỳ trường hợp nào sử dụng trái phép tên hoặc mật khẩu của bạn hoặc bất kỳ trường hợp vi phạm bảo mật nào, và</li>
	<li>Đảm bảo rằng bạn luôn đăng xuất tài khoản của bạn vào cuối mỗi buổi học. Chúng tôi sẽ không chịu trách nhiệm cho bất kỳ tổn thất hoặc thiệt hại phát sinh do bạn không tuân thủ quy định này. Bạn nên đặc biệt thận trọng khi truy cập vào tài khoản của bạn từ một máy tính công cộng để những người khác không thể xem hoặc ghi lại mật khẩu của bạn hoặc thông tin cá nhân khác. Nếu bạn chia sẻ máy tính của bạn với người khác, bạn có thể muốn xem xét việc vô hiệu hóa bất kỳ tính năng tự động đăng nhập nào nếu có liên kết đến tài khoản Học Gì Đây? của bạn.
</li>
</ul>
 

<h3>TƯƠNG TÁC CỦA BẠN VỚI THÀNH VIÊN KHÁC VÀ GIỚI HẠN VỀ TRÁCH NHIỆM PHÁP LÝ CỦA CHÚNG TÔI
 </h3> 

<p>KHÔNG THÀNH VIÊN NÀO BĂT BUỘC PHẢI GẶP MẶT OFFLINE VỚI THÀNH VIÊN KHÁC. BẠN ĐỒNG Ý THẬN TRỌNG TRONG TẤT CẢ TƯƠNG TÁC VỚI CÁC THÀNH VIÊN KHÁC CỦA CÁC DỊCH VỤ CỦA CHÚNG TÔI. BẠN HIỂU RẰNG CHÚNG TÔI KHÔNG BẢO ĐẢM, TƯỜNG MINH HAY NGỤ Ý, VỀ KINH NGHIỆM CỦA BẠN VỚI CÁC THÀNH VIÊN BẠN GẶP QUA CÁC DỊCH VỤ CỦA CHÚNG TÔI.
</p>
<p>HỌC GÌ ĐÂY? VÀ NHÂN VIÊN, CŨNG NHƯ QUẢN LÝ CỦA HỌC GÌ ĐÂY? ĐỀU KHÔNG CHỊU TRÁCH NHIỆM VỚI BẠN HOẶC BÊN THỨ BA, TRONG BẤT KỲ TRƯỜNG HỢP NÀO, CHO BẤT CỨ THIỆT HẠI NÀO, DÙ TRỰC TIẾP, GIÁN TIẾP, THIỆT HẠI CHUNG, ĐẶC BIỆT, THIỆT HẠI ĐƯỢC ĐỀN BÙ, DO HẬU QUẢ, VÀ THIỆT HẠI BẤT NGỜ, BAO GỒM MẤT LỢI NHUẬN, PHÁT SINH BÊN NGOÀI HOẶC LIÊN QUAN ĐẾN BẤT CỨ HÀNH ĐỘNG HOẶC THIẾU SÓT NÀO CỦA BẠN, HỌC GÌ ĐÂY? VÀ CÁC NHÂN VIÊN, QUẢN LÝ CỦA HỌC GÌ ĐÂY? HOẶC DỊCH VỤ ĐIỀU TRA BÊN THỨ 3 CỦA CHÚNG TÔI, BẤT CỨ THÀNH VIÊN NÀO HAY BẤT CỨ AI KHÁC LIÊN QUAN ĐẾN VIỆC SỬ DỤNG DỊCH VỤ CỦA CHÚNG TÔI HOẶC WEBSITE, BAO GỒM KHÔNG GIỚI HẠN, CÁC THƯƠNG TÍCH TÂN THỂ, ĐAU ĐỚN TINH THẦN HOẶC BẤT CỨ THIỆT HẠI KHÁC DO GIAO TIẾP HOẶC GẶP MẶT VỚI NGƯỜI DÙNG KHÁC CỦA DỊCH VỤ CỦA CHÚNG TÔI HOẶC VỚI NHỮNG NGƯỜI BẠN GẶP QUA CÁC DỊCH VỤ CỦA CHÚNG TÔI.
 </p> 

<h2>10. DỊCH VỤ CHĂM SÓC KHÁCH HÀNG
 </h2> 

<p>Chúng tôi có thể cung cấp hỗ trợ và hướng dẫn thông qua các đại diện chăm sóc khách hàng của chúng tôi. Những cú điện thoại giữa bạn và người đại diện chăm sóc khách hàng của chúng tôi có thể được ghi với mục đích đảm bảo chất lượng. Nếu chúng ta cảm thấy rằng hành vi của bạn đối với bất kỳ đại diện chăm sóc khách hàng của chúng tôi hoặc các nhân viên khác là bất cứ lúc nào đe dọa hoặc tấn công, chúng tôi có quyền chấm dứt ngay thành viên của bạn và bạn sẽ không được hưởng bất kỳ khoản hoàn lại phí thuê bao không sử dụng.
</p>
 

<h2>11. CÁC THAY ĐỔI ĐẾN DỊCH VỤ
 </h2> 

<p>Chúng tôi có quyền sửa đổi hoặc ngừng Dịch vụ của chúng tôi tạm thời hoặc vĩnh viễn tại bất kỳ lúc nào mà không có thông báo. Bạn đồng ý rằng chúng tôi sẽ không chịu trách nhiệm với bạn hoặc bất kỳ bên thứ ba nào về việc điều chỉnh, tạm ngừng hoặc ngừng dịch vụ của chúng tôi. Các thông báo về thay đổi dịch vụ của chúng tôi sẽ được gửi tới các bạn dưới dạng tin nhắn nhanh SMS.
</p>
 

<h2>12. TRANH CHẤP GIỮA CÁC THÀNH VIÊN
 </h2> 

<p>Bạn hoàn toàn tự chịu trách nhiệm đối với tương tác của bạn với các Thành viên khác. Chúng tôi có quyền, nhưng không có nghĩa vụ giám sát các tranh chấp giữa bạn và các Thành viên khác.
</p>
 

<h2>13. QUYỀN RIÊNG TƯ VÀ GIAO TIẾP
 </h2> 

<p>Việc sử dụng dịch vụ của chúng tôi cũng được điều chỉnh bởi chính sách bảo mật. Khi bạn trở thành Thành viên, bạn đã đồng ý nhận email từ chúng tôi. Những email này có thể là các giao dịch hoặc các giao tiếp quan hệ liên quan đến dịch vụ của chúng tôi, chẳng hạn như thông báo hành chính và các thông báo hoặc các thay đổi dịch vụ, hoặc các email có chứa quảng cáo hoặc các chương trình khuyến mại đặc biệt từ chúng tôi. Xin vui lòng xem Chính sách bảo mật của chúng tôi để biết thêm thông tin.
</p>
